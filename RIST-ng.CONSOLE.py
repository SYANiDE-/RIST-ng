...
OPTS = {
    'browser':1, 'selenium':0, 'always_on_top':0,
    'mozilla_path':"None", 'firefox_path':"None", 'netscape_path':"None", 
    'galeon_path':"None", 'epiphany_path':"None", 'skipstone_path':"None",
    'kfmclient_path':"None", 'konqueror_path':"None", 'kfm_path':"None", 
    'mosaic_path':"None", 'opera_path':"None", 'grail_path':"None", 
    'links_path':"None", 'elinks_path':"None", 'lynx_path':"None", 
    'w3m_path':"None", 'windows-default_path':"None", 'macosx_path':"None",
    'safari_path':"None", 'google-chrome_path':"None", 'chrome_path':"None", 
    'chromium_path':"None", 'chromium-browser_path':"None"
}
SELENIUMS = { 
...
class mainWindow(BaseWidget):
    ...
    def _get_settings(self):
        global WORKING_SET
        global WORKING_OPT
        settingsdummy = pickle.load(open(Persist+path.sep+Persist_settings, 'rb'))
        optionsdummy = pickle.load(open(Persist+path.sep+Persist_options, 'rb'))
        WORKING_SET = []
        WORKING_OPT = {}
        for item in settingsdummy.split("\n"):
            name, setting = item.split(":")
            for lineitem in OBJS:
                if lineitem[0] == name:
                    WORKING_SET.append([name, setting])
        for item in optionsdummy.split("\n"):
